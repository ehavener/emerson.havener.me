    ...
    <div className="content">
      ...
      <div className="social-icons">
        ...
        <a title="LinkedIn" href="https://www.linkedin.com/in/emerson-havener-8737a1121/" target="_blank" rel="noopener noreferrer">
          <span className="fa-layers fa-fw">
            <FontAwesomeIcon className="outline" transform="shrink-3" icon={faLinkedIn} aria-hidden="true" />
            <FontAwesomeIcon className="solid faSquareFull" icon={faLinkedIn} transform="shrink-3" mask={faSquare} aria-hidden="true" />
          </span>
          <p>LinkedIn</p>
        </a>
        {/*
        <a title="Codepen" href="https://codepen.io/ehavener/" target="_blank" rel="noopener noreferrer">
          <span className="fa-layers fa-fw">
            ...
            <FontAwesomeIcon className="solid" icon={faCodepen} transform="shrink-3" mask={faSquare} aria-hidden="true" />
          </span>
          <p>Codepen</p>
        </a>
        */}
        ...
        <a title="Resume" className="resumeLayers" href="https://www.emerson.havener.me" target="_blank" rel="noopener noreferrer">
          <span className="fa-layers fa-fw">
            <FontAwesomeIcon className="outline" icon={faFilePdf} aria-hidden="true" />
            <FontAwesomeIcon className="solid" icon={fasFilePdf} aria-hidden="true" />
          </span>
          <p>Resume</p>
        </a>
      </div>
